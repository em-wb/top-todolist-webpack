...
function renderList(list, i) {
  ...
  const icon = list.icon
    ? (0,_createElement__WEBPACK_IMPORTED_MODULE_2__["default"])("div", "list-icon", listItem, list.icon, [
        ["id", "list-icon"],
      ])
    : null;
  if (i !== 0) {
