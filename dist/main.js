...
function renderMenuEvLis() {
  ...
  document.getElementById("menuItem1").addEventListener("click", () => {
    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.renderCoreApp)(_lists__WEBPACK_IMPORTED_MODULE_0__.allLists[0]);
  });

  document.getElementById("menuItem3").addEventListener("click", () => {
    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.clearContents)();
    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.renderAllLists)();
  });

  document.getElementById("menuItem4").addEventListener("click", () => {
    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.clearContents)();
    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.renderProfile)();
  });
}
...
/* harmony export */   renderAllLists: () => (/* binding */ renderAllLists),
...
function renderListItems() {
  const listCtr = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("div", "list-ctr", content, "");
  _lists__WEBPACK_IMPORTED_MODULE_1__.allLists.forEach((list) => {
    const listItem = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("div", "list-item", listCtr);
    const textCtr = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("div", "text-ctr", listItem);
    (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("h4", "listTitle", textCtr, list.title);
    (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("p", "list-desc", textCtr, list.description);
    const listColor = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])(
      "div",
  ...
  (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("hr", "break", listCtr);
}
...
function renderProfileInfo() {
  ...
  (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("h1", "user-name", profileCtr, "User: Vivi90");
  (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])(
    "i",
