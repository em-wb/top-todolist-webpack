...
/* harmony export */   editedTaskLog: () => (/* binding */ editedTaskLog),
...
function renderListForm(listToEdit) {
  ...
  (0,_addNew__WEBPACK_IMPORTED_MODULE_0__.renderCloseBtn)(viewCtr);
...
function deleteTaskEL(deleteTaskBtn) {
  deleteTaskBtn.addEventListener("click", (e) => {
    ...
    (0,_appUI__WEBPACK_IMPORTED_MODULE_4__.addTaskCtrs)();
    (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.loadTasksFromStorage)(1); //currentlist
...
/* harmony import */ var _addNewTask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addNewTask */ "./src/addNewTask.js");
...
function renderItemDelete(ctr, index) {
  ...
  const deleteBtn = (0,_createElement__WEBPACK_IMPORTED_MODULE_2__["default"])("button", "delete-list", openEditDiv, "", [
...
function editListEL() {
  ...
  editBtns.forEach((editBtn) => {
    editBtn.addEventListener("click", () => {
      ...
      (0,_addNewTask__WEBPACK_IMPORTED_MODULE_3__.editedLog)(listToEdit);
      (0,___WEBPACK_IMPORTED_MODULE_0__["default"])();
...
function renderItemEdit(ctr, index) {
  ...
  const editBtn = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])("button", "open-edit", openEditDiv, "", [
    ["data-index-number", index],
  ]);
  (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])(
    "i",
...
function renderListColor(item, ctr) {
  const listColor = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])("div", "list-color", ctr);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_tasks__WEBPACK_IMPORTED_MODULE_3__.loadTasksFromStorage)(1);
  addNewEventLi();
});
...
function checkType() {
  ...
  if (allLists.classList.contains("selected")) {
    (0,_addNewList__WEBPACK_IMPORTED_MODULE_2__.renderListForm)();
  } else (0,_addNewTask__WEBPACK_IMPORTED_MODULE_1__.renderTaskForm)();
}
...
function renderTask(task, index) {
  ...
  (0,_appUI__WEBPACK_IMPORTED_MODULE_4__.renderListColor)(task, viewEditDiv);
...
function loadTasksFromStorage(listID) {
  ...
  if (tasks.length > 0) {
    ...
    return (0,_list__WEBPACK_IMPORTED_MODULE_1__.getListInfo)(listID);
  } else {
    (0,_list__WEBPACK_IMPORTED_MODULE_1__.getListInfo)(listID);
  }
